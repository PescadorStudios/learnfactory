...
const LANE_GAP = 16; // separación lateral entre venas (unidades de mundo)
const LAYER_GAP = 32; // separación en profundidad entre estaciones (más aire = sensación de viaje)
